...
mqtt_topic = "/devices/{}/{}".format('Camera_rig', sub_topic)
...
for i in range(1, 10):
    ...
    if should_backoff:
        ...
        clint.connect('mqtt.googleapis.com', 8883)

    payload = "{}/{}-payload-{}".format('Plant_Cam', 'Main_Pi', i)
    print("Publishing message {}/{}: '{}'".format(i, 10, payload))
